...
def generate_launch_description():
    ...
    go_to_pose_service_server_node = Node(
        name="go_to_pose_service_server",
        package="moveit2_services",
        executable="go_to_pose_service_server",
        output="screen",
        parameters=[
            ...
            {'reference_frame': 'wrist_rgbd_camera_link'},
        ],                   
    )
    ...
    return LaunchDescription([
        use_sim_time_arg,
        go_to_pose_service_server_node, 
    ])