...
int main(int argc, char **argv) {
  ...
  auto move_group_node = rclcpp::Node::make_shared("scene", node_options);
  ...
  // Coffee machine head
  auto const collision_object_coffee_machine_head =
      [frame_id = move_group_arm.getPlanningFrame()] {
        moveit_msgs::msg::CollisionObject collision_object;
        collision_object.header.frame_id = frame_id;
  ...
  auto const collision_object_coffee_machine_nozzle =
      [frame_id = move_group_arm.getPlanningFrame()] {
        moveit_msgs::msg::CollisionObject collision_object;
        collision_object.header.frame_id = frame_id;
  ...
  planning_scene_interface.applyCollisionObject(
      collision_object_coffee_machine_head);
  planning_scene_interface.applyCollisionObject(
      collision_object_coffee_machine_nozzle);
